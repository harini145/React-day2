...
import pic1 from "../src/Images/download.jpg";
import pic2 from "../src/Images/9.jpg"
...
<div class ="title">
    <br/><br/><h1>SPRINKLES</h1><br/>
    <p>
        one of the World's Largest Shoe store
    </p><br/><br/><br/><br/>
...
<section id="header1">
    <nav>
        <div class="headertext">
               <h2>
                WELCOME to the About page of the world's largest shoe store. 
                </h2><br/>
                <div class="img2">
